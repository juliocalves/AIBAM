...
namespace AIBAM
{
    public partial class FrmCatalogo : Form
    {
        ...
        {
            colecao.Nome = txtPesquisaCatalogo.Text;
        ...
        private void dgvProdutos_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            }else if (e.RowIndex >= 0 && dgvProdutos.Columns[e.ColumnIndex].Name == "select")
            {
        ...
        {
            var _catalogos = new List<Colecao>();
            ColecaoService colecaoService = new();
            _catalogos = await colecaoService.ListarColecaoAsync();
        ...
        {
            txtPesquisaCatalogo.Text = colecao.Nome;
        ...
        private void btnProximo_Click(object sender, EventArgs e)
        {
            if (navegador.TemProximo()) // Verifica se há próximo item
            {
                ...
                _ = AtribuirCatalogoAsync(); // Reatribui os dados do Coleção à interface
            }
